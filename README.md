...
## Screenshots of the Project
  <![screenshot]('../img/screenshots/landing.png')  <![screenshot]('../img/screenshots/doc1.png')  <![screenshot]('../img/screenshots/doc2.png')  <![screenshot]('../img/screenshots/modal1.png')  <![screenshot]('../img/screenshots/spit-verse.png')  <![screenshot]('../img/screenshots/lorem-minaj.png')  <![screenshot]('../img/screenshots/about.png')  
